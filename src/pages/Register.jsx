...
export default function Register() {
  return (
    ...
    <AiFillGoogleCircle className='w-full md:hidden text-4xl mx-6 text-red-600 shadow-md hover:bg-red-700 transition duration-200 ease-in-out active:bg-red-800' />
    <AiFillInstagram className='w-full md:hidden text-4xl mx-6 text-red-600 shadow-md hover:bg-red-700 transition duration-200 ease-in-out active:bg-red-800' />
    <AiFillFacebook className='w-full md:hidden text-4xl mx-6 text-red-600 shadow-md hover:bg-red-700 transition duration-200 ease-in-out active:bg-red-800' />
    </div>
    </form>
    </div>
    </main>
